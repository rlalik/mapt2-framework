#ifndef GeometryReadInCGAL_h
#define GeometryReadInCGAL_h 1
...
//! \brief Reads the geometry text file, creates the detector parts defined in the geometry text file, and adds them to the geometry (UserCGALGeometry).
/*!
...
class GeometryReadInCGAL
{
  public:
    ...
    GeometryReadInCGAL (UserCGALGeometry* geo, string filename_);
