...
// ********************************************************************
//
// $Id: MAPTEmStandardPhysics.cc 84662 2014-10-17 14:32:32Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   MAPTEmStandardPhysics
//
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(MAPTEmStandardPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

MAPTEmStandardPhysics::MAPTEmStandardPhysics(G4int ver)
  : G4VPhysicsConstructor("MAPTEmStandard"), verbose(ver)
{
...
MAPTEmStandardPhysics::MAPTEmStandardPhysics(G4int ver, const G4String&)
  : G4VPhysicsConstructor("MAPTEmStandard"), verbose(ver)
{
  G4EmParameters::Instance()->SetVerbose(verbose);
  SetPhysicsType(bElectromagnetic);
...
MAPTEmStandardPhysics::~MAPTEmStandardPhysics()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void MAPTEmStandardPhysics::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void MAPTEmStandardPhysics::ConstructProcess()
{
  if(verbose > 1) {
